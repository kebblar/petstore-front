            ...
            <div class="row">
                <b-table
                        ...
                        <template #cell(Acciones)="row">
                            <b-button variant="success" @click="openEdit(row.item.id, row.item.nombre, row.item.idEstado)" class="mr-4">Editar</b-button>
    ...
    export default {
        ...
        methods: {
            ...
            openEdit(id, nombre, idEstado){
                ...
                axios.get('api/estados/'+idEstado+'.json', {
                }).then(response => {
                    console.log("enviado");
            ...
            agregarMunicipio() {
                console.log(store.state);
                axios.post('api/municipios.json', {
                    id:4,
            ...
            eliminarMunicipio() {
                axios.delete('api/municipios/delete/'+this.idActual+'.json', {
                }).then(response => {
                    console.log("enviado");
                    console.log(response);
                    this.municipios=response.data;
