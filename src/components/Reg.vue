...
<div class="ancho centra">
  <div class="card defaultColor" style="width:450px;">
    ...
    <div class="card-body align" style="margin-top:20px;">
        ...
        <div class ="form-row form-group">
          <div class="col-md-4">
            <label for="sndLast">Apellido Materno:</label>
          </div>
          <div class="col">
        ...
        <div class="form-row ">
            <vue-recaptcha sitekey="6Le5uroaAAAAADen22qpov_2nbZq0zYY0dmg_kxj" 
  ...
  export default {
    ...
    methods: {
      ...
      onCaptchaVerified(value){
        this.captcha=true;                  //linea que debe ser borrada al conectar al back
        axios.post('api/captchaPba', {
          response : value,
          ip : '127.0.0.1'
        }).then(response => {
          this.captcha=true;
          console.log("captcah enviado al back");
          console.log(response);
          console.log(response.data);
          console.log(response.status);
         }).catch(e => {
