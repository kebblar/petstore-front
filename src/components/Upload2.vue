    ...
    <div style="width:400px;">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 class="modal-title">Crop & Rotate file</h5>
            ...
            <div class="form-group" v-if="editFile.show && editFile.blob && editFile.type && editFile.type.substr(0, 6) === 'image/'">
              ...
              <div class="edit-image-tool">
                <div class="btn-group" role="group">
                  <button type="button" class="btn btn-primary" @click="rotateRight()" title="cropper.rotate(-90)"><i class="fa fa-undo" aria-hidden="true"></i></button>
                  <button type="button" class="btn btn-primary" @click="rotateLeft()"  title="cropper.rotate(90)"><i class="fa fa-repeat" aria-hidden="true"></i></button>
                </div>
                <div class="btn-group" role="group">
                  <button type="button" class="btn btn-primary" @click="onEditorFile()" title="cropper.crop()"><i class="fa fa-check" aria-hidden="true"></i></button>
                  <button type="button" class="btn btn-primary" @click="oculta()"      title="cropper.clear()"><i class="fa fa-times" aria-hidden="true"></i></button>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      thread: 3,
      name: 'file',
      postAction: '/api/upload/post',
      putAction: '/api/upload/put',
      headers: {
        'X-Csrf-Token': 'xxxx',
      },
      data: {
