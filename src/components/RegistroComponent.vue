...
<!--        Nickname-->
        <div class="form-group">
          <div class="row px-3">
            <input @click="activoClave=false" type="text" required placeholder="Mi nickname" class="form-control" :class="className" id="text-usr" v-model="name" />
...
<!--        Correo-->
        <div class="form-group">
          <div class="row px-3">
            <input @click="activoClave=false" type="email" required class="form-control" :class="classMail" id="text-usr" placeholder="ejemplo@gmail.com" v-model="email">
