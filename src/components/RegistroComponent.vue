...
<!--        Password-->
        <div class="form-group">
          <div class="row px-3">
            <input autocomplete="off" @click="activoClave=true" :type=pwInputValue :class="classPasswd" maxlength="20" placeholder="*****" class="form-control" id="password" v-model="password" />
