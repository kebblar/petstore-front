...
import ChartContainerTipoPago from '@/components/ChartContainerTipoPago'
import ChartTipoPago from '@/components/ChartTipoPago'
...
const routes = [{
    ...
    {
        path: '/ui/chartContainer-TipoPago',
        name: 'ChartContainerTipoPago',
        component: ChartContainerTipoPago
    },
    {
        path: '/ui/char-TipoPago',
        name: 'ChartTipoPago',
        component: ChartTipoPago
    },
]
